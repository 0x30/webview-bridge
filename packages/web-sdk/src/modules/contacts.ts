...
export class ContactsModule implements BridgeModule {
  ...
  async getContacts(params?: GetContactsParams): Promise<GetContactsResult> {
    return this.bridge.send<GetContactsResult>('Contacts.GetContacts', params as Record<string, unknown>)
  }
  ...
  async createContact(contact: CreateContactParams): Promise<{ success: boolean; identifier: string }> {
    return this.bridge.send<{ success: boolean; identifier: string }>('Contacts.CreateContact', contact as unknown as Record<string, unknown>)
  }
}
