...
public class WebViewBridge: NSObject {
    ...
    private func registerBuiltInModules() {
        ...
        register(module: BrowserModule(bridge: self))
        ...
        register(module: MotionModule(bridge: self))
        register(module: NavigatorModule(bridge: self))
        ...
        register(module: ScreenOrientationModule(bridge: self))
