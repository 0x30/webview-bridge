...
class ContactsModule(
    ...
    private fun createContact(
        ...
        scope.launch(Dispatchers.IO) {
            try {
                ...
                if (displayName.isNotEmpty()) {
                    operations.add(
                        android.content.ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
                            ...
                            .withValue(ContactsContract.CommonDataKinds.StructuredName.GIVEN_NAME, request.getString("givenName"))
                            .withValue(ContactsContract.CommonDataKinds.StructuredName.FAMILY_NAME, request.getString("familyName"))
                            .build()
                    )
                }
                ...
                val phones = request.params["phones"] as? List<Map<String, Any?>>
                ...
                // 插入邮箱
                @Suppress("UNCHECKED_CAST")
                val emails = request.params["emails"] as? List<Map<String, Any?>>
    ...
    private fun readContactFromCursor(cursor: Cursor): Map<String, Any?> {
        ...
        val photoUri = cursor.getString(cursor.getColumnIndexOrThrow(ContactsContract.Contacts.PHOTO_THUMBNAIL_URI))
